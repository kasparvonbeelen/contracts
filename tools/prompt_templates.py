...
You need to generate a new example of a {0} clause that has the legal function and meaning but uses different words. 
...
def generate_negative_prompts_few_shot(clause_type, definitions, data, num_examples):
    definition = definitions[clause_type]
    return  ["""You are a helpful AI that creates synthetic data by generating legal clauses for terms of use.
...
We give a definition of a {0} clause. You need to generate a new example of a {0} clause that has the legal function and meaning but uses different words AND sentence structure
...
You need to generate a new sentence that has the legal function as {0} clause but uses different words AND sentence structure. 
...
You need to generate a new example of a {0} clause that has the legal function and meaning but uses different words than these synthetic examples. 
